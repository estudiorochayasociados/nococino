    ...
    <form method="post" class="row">
        ...
        <label class="col-md-2">
            ...
            <select name="vendedor">
                ...
                <option value="1" <?php if($usuario['vendedor'] == 1){echo 'selected';} ?>>Si</option>
                <option value="0" <?php if($usuario['vendedor'] == 0){echo 'selected';} ?>>No</option>
            </select>
        </label>
        <label class="col-md-2">
            Plan:<br/>
            <select name="plan">
                <option selected disabled>Seleccionar</option>
                <option value="1" <?php if($usuario['plan'] == 1){echo 'selected';} ?>>Básico</option>
                <option value="2" <?php if($usuario['plan'] == 2){echo 'selected';} ?>>Medio</option>
                <option value="3" <?php if($usuario['plan'] == 3){echo 'selected';} ?>>Completo</option>
            </select>
        </label>
