            ...
            <table class="table  table-bordered  ">
                ...
                if (is_array($data)) {
                    for ($i = 0; $i < count($data); $i++) {
                        ...
                        echo '<a class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="Eliminar" href="' . URL . '/index.php?op=usuarios&accion=verPendientes&borrar=' . $data[$i]["cod"] . '">
...
if (isset($_GET["borrar"])) {
    ...
    $usuarios->set("cod",$cod);
    $usuarios->delete();
    $funciones->headerMove(URL . "/index.php?op=usuarios&accion=verPendientes");
}
?>